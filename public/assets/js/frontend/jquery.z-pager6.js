		...
		dataRender: function(_v, _data){
			...
			var cells = '';
				for(var i=0;i<_data.length;i++){
					cells += '<div class="about_media_item"><img src="' + _data[i].thumb + '" /> <div class="am_right"><p class="am_tit">' + _data[i].title + '</p><p class="about_txt">' + _data[i].content + '</p><a href="/dynamic/'+ _data[i].id +'.html">阅读全文</a> </div></div>';
				}

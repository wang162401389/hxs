		...
		dataRender: function(_v, _data){
			...
			var cells = '';
				for(var i=0;i<_data.length;i++){
					cells += '<div class="item clearfix"><img src="' + _data[i].picurl + '"}><p>' + _data[i].title + '</p><div class="more_wrap"><a href="'+ _data[i].id +'.html" target="_blank" class="more">查看</a></div></div>';
				}
